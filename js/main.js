...
var generateLikes = function (maxLikes, minLikes) {
  var likes = [];
...
var generateLinksImgs = function (minURL, maxURL) {
  var linkImg = [];
...
var generateDescriptionPhotos = function (likesPhotos, urlsPhotos, comments) {
